    ...
    <section className='section-container py-20' id='ServicesSection'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='text-center mb-16 max-w-5xl mx-auto'>
          <h2 className='heading-section mb-6 px-2 sm:px-4 capitalize'>
            {t('servicesTitle')}
          </h2>
          <div className='text-lg max-w-3xl mx-auto text-gray-600 leading-relaxed'>
            {t('servicesSubtitle')
              .split('\n')
              .map((line, index) => (
                <div key={index} className='mb-2'>
                  <span className='text-[#54BD95] font-medium'>
                    {line.trim()}
                  </span>
                </div>
              ))}
