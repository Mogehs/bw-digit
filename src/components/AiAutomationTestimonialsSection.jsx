...
const AiAutomationTestimonialsSection = ({ testimonials }) => {
              ...
              >
                <div className='w-24 h-24 mb-6'>
                  <img
                    ...
                    alt={t(
                      `services.ai.testimonials.items.${testimonial.id}.author`
                    )}
                    className='w-full h-full rounded-full object-cover'
                  />
                </div>
                <h3 className='text-xl font-semibold mb-4'>
                  {t(`services.ai.testimonials.items.${testimonial.id}.author`)}
                </h3>
                <div className='flex space-x-1 mb-4'>{renderStars()}</div>
                <p className='text-accent font-semibold mb-2'>
                  {t(
                    `services.ai.testimonials.items.${testimonial.id}.position`
                  )}
                </p>
                <p className='text-gray-600 text-sm leading-relaxed'>
                  "{t(`services.ai.testimonials.items.${testimonial.id}.quote`)}
                  "
                </p>
              </div>
            ))}
...
export default AiAutomationTestimonialsSection;
